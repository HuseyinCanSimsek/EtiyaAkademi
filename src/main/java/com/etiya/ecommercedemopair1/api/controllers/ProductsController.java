...
public class ProductsController {
    ...
    @PostMapping("/add")
    public GetProductResponse addProduct(@RequestBody @Valid AddProductRequest p)
    {
        return productService.addProduct(p);
    }
    @PostMapping("/addone")
    public ResponseEntity<GetProductResponse> addProductOne(@RequestBody @Valid AddProductRequest p)
    {
